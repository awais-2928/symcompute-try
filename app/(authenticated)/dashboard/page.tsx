...
export default async function DashboardPage() {
  ...
  const [
    ...
    prisma.bareMetalServer.count({ where: { organizationId: orgId, deletedAt: null } }),
    prisma.bareMetalServer.count({ where: { organizationId: orgId, status: "ACTIVE", deletedAt: null } }),
    prisma.vm.count({ where: { organizationId: orgId, deletedAt: null } }),
    prisma.vm.count({ where: { organizationId: orgId, status: "ACTIVE", deletedAt: null } }),
    prisma.customer.count({ where: { organizationId: orgId, deletedAt: null } }),
    prisma.customer.count({ where: { organizationId: orgId, status: "ACTIVE", deletedAt: null } }),
    prisma.quotation.count({ where: { organizationId: orgId, deletedAt: null } }),
    prisma.quotation.count({ where: { organizationId: orgId, status: "SENT", deletedAt: null } }),
